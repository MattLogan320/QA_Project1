...
class Books(db.Model):
    ...
    customerBook1= db.relationship('CustomerBoooks', backref=db.backref('book',lazy = True))
...
class Customers(db.Model):
    ...
    customerBook2= db.relationship('CustomerBoooks', backref=db.backref('customer',lazy = True))
